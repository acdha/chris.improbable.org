...
(function () {
    ...
    TwitterCldr.Utilities = (function () {
        ...
        Utilities.max = function (arr) {
            ...
            max = null;
            for (
                start_index = _i = 0, _len = arr.length;
                _i < _len;
                start_index = ++_i
            ) {
    ...
    TwitterCldr.TimespanFormatter = (function () {
            ...
            this.tokens = {
                ago: {
                    second: {
                        default: {
                            one: [
                                { value: "{0}", type: "placeholder" },
                                { value: " second ago", type: "plaintext" },
                            ],
                            other: [
                                { value: "{0}", type: "placeholder" },
                                { value: " seconds ago", type: "plaintext" },
                            ],
                        },
                    },
                    minute: {
                        default: {
                            one: [
                                { value: "{0}", type: "placeholder" },
                                { value: " minute ago", type: "plaintext" },
                            ],
                            other: [
                                { value: "{0}", type: "placeholder" },
                                { value: " minutes ago", type: "plaintext" },
                            ],
                        },
                    },
                    hour: {
                        default: {
                            one: [
                                { value: "{0}", type: "placeholder" },
                                { value: " hour ago", type: "plaintext" },
                            ],
                            other: [
                                { value: "{0}", type: "placeholder" },
                                { value: " hours ago", type: "plaintext" },
                            ],
                        },
                    },
                    day: {
                        default: {
                            one: [
                                { value: "{0}", type: "placeholder" },
                                { value: " day ago", type: "plaintext" },
                            ],
                            other: [
                                { value: "{0}", type: "placeholder" },
                                { value: " days ago", type: "plaintext" },
                            ],
                        },
                    },
                    week: {
                        default: {
                            one: [
                                { value: "{0}", type: "placeholder" },
                                { value: " week ago", type: "plaintext" },
                            ],
                            other: [
                                { value: "{0}", type: "placeholder" },
                                { value: " weeks ago", type: "plaintext" },
                            ],
                        },
                    },
                    month: {
                        default: {
                            one: [
                                { value: "{0}", type: "placeholder" },
                                { value: " month ago", type: "plaintext" },
                            ],
                            other: [
                                { value: "{0}", type: "placeholder" },
                                { value: " months ago", type: "plaintext" },
                            ],
                        },
                    },
                    year: {
                        default: {
                            one: [
                                { value: "{0}", type: "placeholder" },
                                { value: " year ago", type: "plaintext" },
                            ],
                            other: [
                                { value: "{0}", type: "placeholder" },
                                { value: " years ago", type: "plaintext" },
                            ],
                        },
                    },
                },
                until: {
                    second: {
                        default: {
                            one: [
                                { value: "In ", type: "plaintext" },
                                { value: "{0}", type: "placeholder" },
                                { value: " second", type: "plaintext" },
                            ],
                            other: [
                                { value: "In ", type: "plaintext" },
                                { value: "{0}", type: "placeholder" },
                                { value: " seconds", type: "plaintext" },
                            ],
                        },
                    },
                    minute: {
                        default: {
                            one: [
                                { value: "In ", type: "plaintext" },
                                { value: "{0}", type: "placeholder" },
                                { value: " minute", type: "plaintext" },
                            ],
                            other: [
                                { value: "In ", type: "plaintext" },
                                { value: "{0}", type: "placeholder" },
                                { value: " minutes", type: "plaintext" },
                            ],
                        },
                    },
                    hour: {
                        default: {
                            one: [
                                { value: "In ", type: "plaintext" },
                                { value: "{0}", type: "placeholder" },
                                { value: " hour", type: "plaintext" },
                            ],
                            other: [
                                { value: "In ", type: "plaintext" },
                                { value: "{0}", type: "placeholder" },
                                { value: " hours", type: "plaintext" },
                            ],
                        },
                    },
                    day: {
                        default: {
                            one: [
                                { value: "In ", type: "plaintext" },
                                { value: "{0}", type: "placeholder" },
                                { value: " day", type: "plaintext" },
                            ],
                            other: [
                                { value: "In ", type: "plaintext" },
                                { value: "{0}", type: "placeholder" },
                                { value: " days", type: "plaintext" },
                            ],
                        },
                    },
                    week: {
                        default: {
                            one: [
                                { value: "In ", type: "plaintext" },
                                { value: "{0}", type: "placeholder" },
                                { value: " week", type: "plaintext" },
                            ],
                            other: [
                                { value: "In ", type: "plaintext" },
                                { value: "{0}", type: "placeholder" },
                                { value: " weeks", type: "plaintext" },
                            ],
                        },
                    },
                    month: {
                        default: {
                            one: [
                                { value: "In ", type: "plaintext" },
                                { value: "{0}", type: "placeholder" },
                                { value: " month", type: "plaintext" },
                            ],
                            other: [
                                { value: "In ", type: "plaintext" },
                                { value: "{0}", type: "placeholder" },
                                { value: " months", type: "plaintext" },
                            ],
                        },
                    },
                    year: {
                        default: {
                            one: [
                                { value: "In ", type: "plaintext" },
                                { value: "{0}", type: "placeholder" },
                                { value: " year", type: "plaintext" },
                            ],
                            other: [
                                { value: "In ", type: "plaintext" },
                                { value: "{0}", type: "placeholder" },
                                { value: " years", type: "plaintext" },
                            ],
                        },
                    },
                },
                none: {
                    second: {
                        ...
                        short: {
                            one: [
                                { value: "{0}", type: "placeholder" },
                                { value: " sec", type: "plaintext" },
                            ],
                            other: [
                                { value: "{0}", type: "placeholder" },
                                { value: " secs", type: "plaintext" },
                            ],
                        },
                        abbreviated: {
                            one: [
                                { value: "{0}", type: "placeholder" },
                                { value: "s", type: "plaintext" },
                            ],
                            other: [
                                { value: "{0}", type: "placeholder" },
                                { value: "s", type: "plaintext" },
                    ...
                    minute: {
                        ...
                        short: {
                            one: [
                                { value: "{0}", type: "placeholder" },
                                { value: " min", type: "plaintext" },
                            ],
                            other: [
                                { value: "{0}", type: "placeholder" },
                                { value: " mins", type: "plaintext" },
                            ],
                        },
                        abbreviated: {
                            one: [
                                { value: "{0}", type: "placeholder" },
                                { value: "m", type: "plaintext" },
                            ],
                            other: [
                                { value: "{0}", type: "placeholder" },
                                { value: "m", type: "plaintext" },
                    ...
                    hour: {
                        ...
                        short: {
                            one: [
                                { value: "{0}", type: "placeholder" },
                                { value: " hr", type: "plaintext" },
                            ],
                            other: [
                                { value: "{0}", type: "placeholder" },
                                { value: " hrs", type: "plaintext" },
                            ],
                        },
                        abbreviated: {
                            one: [
                                { value: "{0}", type: "placeholder" },
                                { value: "h", type: "plaintext" },
                            ],
                            other: [
                                { value: "{0}", type: "placeholder" },
                                { value: "h", type: "plaintext" },
                    ...
                    week: {
                        ...
                        short: {
                            one: [
                                { value: "{0}", type: "placeholder" },
                                { value: " wk", type: "plaintext" },
                            ],
                            other: [
                                { value: "{0}", type: "placeholder" },
                                { value: " wks", type: "plaintext" },
                            ],
                        },
                    },
                    month: {
                        ...
                        short: {
                            one: [
                                { value: "{0}", type: "placeholder" },
                                { value: " mth", type: "plaintext" },
                            ],
                            other: [
                                { value: "{0}", type: "placeholder" },
                                { value: " mths", type: "plaintext" },
                            ],
                        },
                    },
                    year: {
                        ...
                        short: {
                            one: [
                                { value: "{0}", type: "placeholder" },
                                { value: " yr", type: "plaintext" },
                            ],
                            other: [
                                { value: "{0}", type: "placeholder" },
                                { value: " yrs", type: "plaintext" },
                            ],
                        },
                    },
                },
        ...
        TimespanFormatter.prototype.format = function (seconds, fmt_options) {
            ...
            if (options["unit"] === null || options["unit"] === void 0) {
                options["unit"] = this.calculate_unit(
                    Math.abs(seconds),
                    options,
                );
            }
            options["type"] || (options["type"] = this.default_type);
            options["number"] = this.calculate_time(
                Math.abs(seconds),
                options["unit"],
            );
            ...
            strings = function () {
                ...
                _ref =
                    this.tokens[options["direction"]][options["unit"]][
                        options["type"]
                    ][options["rule"]];
                _results = [];
        ...
        TimespanFormatter.prototype.calculate_unit = function (
            seconds,
            unit_options,
        ) {
    ...
    TwitterCldr.DateTimeFormatter = (function () {
                ...
                date_time: {
                    ...
                    additional: {
                        ...
                        Gy: [
                            { value: "y", type: "pattern" },
                            { value: " ", type: "plaintext" },
                            { value: "G", type: "pattern" },
                        ],
                        H: [{ value: "HH", type: "pattern" }],
                        Hm: [
                            { value: "HH", type: "pattern" },
                            { value: ":", type: "plaintext" },
                            { value: "mm", type: "pattern" },
                        ...
                        yQQQ: [
                            { value: "QQQ", type: "pattern" },
                            { value: " ", type: "plaintext" },
                            { value: "y", type: "pattern" },
                        ],
                        yQQQQ: [
                            { value: "QQQQ", type: "pattern" },
                            { value: " ", type: "plaintext" },
                            { value: "y", type: "pattern" },
                        ],
                    },
        ...
        DateTimeFormatter.prototype.get_tokens = function (obj, options) {
            ...
            if (format === "additional") {
                return this.tokens["date_time"][format][
                    this.additional_format_selector().find_closest(options.type)
                ];
            } else {
        ...
        DateTimeFormatter.prototype.result_for_token = function (token, date) {
            return this[this.methods[token.value[0]]](
                date,
                token.value,
                token.value.length,
            );
        ...
        DateTimeFormatter.prototype.additional_format_selector = function () {
            return new TwitterCldr.AdditionalDateFormatSelector(
                this.tokens["date_time"]["additional"],
            );
        };
        ...
        DateTimeFormatter.prototype.year_of_week_of_year = function (
            date,
            pattern,
            length,
        ) {
        ...
        DateTimeFormatter.prototype.day_of_week_in_month = function (
            date,
            pattern,
            length,
        ) {
        ...
        DateTimeFormatter.prototype.quarter = function (date, pattern, length) {
            ...
            switch (length) {
                ...
                case 3:
                    return TwitterCldr.Calendar.calendar.quarters.format
                        .abbreviated[quarter];
                case 4:
                    return TwitterCldr.Calendar.calendar.quarters.format.wide[
                        quarter
                    ];
            }
        };

        DateTimeFormatter.prototype.quarter_stand_alone = function (
            date,
            pattern,
            length,
        ) {
            ...
            switch (length) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    return TwitterCldr.Calendar.calendar.quarters["stand-alone"]
                        .narrow[quarter];
            }
        };
        ...
        DateTimeFormatter.prototype.month = function (date, pattern, length) {
            ...
            switch (length) {
                ...
                case 3:
                    return TwitterCldr.Calendar.calendar.months.format
                        .abbreviated[month_str];
                case 4:
                    return TwitterCldr.Calendar.calendar.months.format.wide[
                        month_str
                    ];
                case 5:
                    throw 'not yet implemented (requires cldr\'s "multiple inheritance")';
        ...
        DateTimeFormatter.prototype.month_stand_alone = function (
            date,
            pattern,
            length,
        ) {
            ...
            switch (length) {
                ...
                case 2:
                    return ("0000" + month_str).slice(-length);
                case 3:
                    return TwitterCldr.Calendar.calendar.months["stand-alone"]
                        .abbreviated[month_str];
                case 4:
                    return TwitterCldr.Calendar.calendar.months["stand-alone"]
                        .wide[month_str];
        ...
        DateTimeFormatter.prototype.weekday = function (date, pattern, length) {
            ...
            switch (length) {
                ...
                case 2:
                case 3:
                    return TwitterCldr.Calendar.calendar.days.format
                        .abbreviated[key];
                case 4:
                    return TwitterCldr.Calendar.calendar.days.format.wide[key];
                case 5:
                    return TwitterCldr.Calendar.calendar.days["stand-alone"]
                        .narrow[key];
            }
        };

        DateTimeFormatter.prototype.weekday_local = function (
            date,
            pattern,
            length,
        ) {
        ...
        DateTimeFormatter.prototype.weekday_local_stand_alone = function (
            date,
            pattern,
            length,
        ) {
        ...
        DateTimeFormatter.prototype.second_fraction = function (
            time,
            pattern,
            length,
        ) {
            ...
            return (
                "000000" +
                Math.round(
                    Math.pow(time.getMilliseconds() * 100.0, 6 - length),
                ).toString()
            ).slice(-length);
        };

        DateTimeFormatter.prototype.timezone = function (
            time,
            pattern,
            length,
        ) {
        ...
        DateTimeFormatter.prototype.timezone_generic_non_location = function (
            time,
            pattern,
            length,
        ) {
    ...
    TwitterCldr.AdditionalDateFormatSelector = (function () {
        ...
        AdditionalDateFormatSelector.prototype.find_closest = function (
            goal_pattern,
        ) {
        ...
        AdditionalDateFormatSelector.prototype.separate = function (
            pattern_key,
        ) {
        ...
        AdditionalDateFormatSelector.prototype.all_separated_patterns =
            function () {
                var key, _results;
                _results = [];
                for (key in this.pattern_hash) {
        ...
        AdditionalDateFormatSelector.prototype.score = function (
            entities,
            goal_entities,
        ) {
            var score;
        ...
        AdditionalDateFormatSelector.prototype.position_score = function (
            entities,
            goal_entities,
        ) {
        ...
        AdditionalDateFormatSelector.prototype.exist_score = function (
            entities,
            goal_entities,
        ) {
        ...
        AdditionalDateFormatSelector.prototype.count_score = function (
            entities,
            goal_entities,
        ) {
        ...
        AdditionalDateFormatSelector.prototype.rank = function (goal_pattern) {
            ...
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                ...
                result[separated_pattern.join("")] = this.score(
                    separated_pattern,
                    separated_goal_pattern,
                );
            }
    ...
    TwitterCldr.NumberFormatter = (function () {
        ...
        NumberFormatter.prototype.format = function (number, options) {
            ...
            (_ref = this.partition_tokens(this.get_tokens(number, opts))),
                (prefix = _ref[0]),
                (suffix = _ref[1]),
                (integer_format = _ref[2]),
                (fraction_format = _ref[3]);
            number = this.transform_number(number);
            (_ref1 = this.parse_number(number, opts)),
                (intg = _ref1[0]),
                (fraction = _ref1[1]);
            ...
            sign =
                number < 0 && prefix !== "-"
                    ? this.symbols.minus_sign || this.default_symbols.minus_sign
                    : "";
        ...
        NumberFormatter.prototype.partition_tokens = function (tokens) {
            return [
                tokens[0] || "",
                tokens[2] || "",
                new TwitterCldr.NumberFormatter.IntegerHelper(
                    tokens[1],
                    this.symbols,
                ),
                new TwitterCldr.NumberFormatter.FractionHelper(
                    tokens[1],
                    this.symbols,
                ),
            ];
    ...
    TwitterCldr.PercentFormatter = (function (_super) {
        ...
        PercentFormatter.prototype.format = function (number, options) {
            ...
            return PercentFormatter.__super__.format
                .call(this, number, options)
                .replace(
                    "¤",
                    this.symbols.percent_sign || this.default_percent_sign,
                );
        };

        PercentFormatter.prototype.default_format_options_for = function (
            number,
        ) {
            return {
                precision: 0,
    ...
    TwitterCldr.DecimalFormatter = (function (_super) {
        ...
        function DecimalFormatter() {
            return DecimalFormatter.__super__.constructor.apply(
                this,
                arguments,
            );
        }
        ...
        DecimalFormatter.prototype.format = function (number, options) {
            ...
            try {
                return DecimalFormatter.__super__.format.call(
                    this,
                    number,
                    options,
                );
        ...
        DecimalFormatter.prototype.default_format_options_for = function (
            number,
        ) {
            return {
                precision: this.precision_from(number),
        ...
        CurrencyFormatter.prototype.format = function (number, options) {
            ...
            if (options.currency) {
                if (TwitterCldr.Currencies != null) {
                    currency = TwitterCldr.Currencies.for_code(
                        options.currency,
                    );
                    currency ||
                        (currency = {
            ...
            symbol = options.use_cldr_symbol
                ? currency.cldr_symbol
                : currency.symbol;
            return CurrencyFormatter.__super__.format
                .call(this, number, options)
                .replace("¤", symbol);
        };

        CurrencyFormatter.prototype.default_format_options_for = function (
            number,
        ) {
            var precision;
            precision = this.precision_from(number);
    ...
    TwitterCldr.AbbreviatedNumberFormatter = (function (_super) {
        ...
        function AbbreviatedNumberFormatter() {
            return AbbreviatedNumberFormatter.__super__.constructor.apply(
                this,
                arguments,
            );
        }
        ...
        AbbreviatedNumberFormatter.prototype.default_format_options_for =
            function (number) {
                return {
                    precision: this.precision_from(number),
                };
        ...
        AbbreviatedNumberFormatter.prototype.get_key = function (number) {
            ...
            zeroes = (function () {
                ...
                _results = [];
                for (
                    i = _i = 0, _ref = Math.floor(number).toString().length - 1;
                    0 <= _ref ? _i < _ref : _i > _ref;
                    i = 0 <= _ref ? ++_i : --_i
                ) {
                    _results.push("0");
        ...
        AbbreviatedNumberFormatter.prototype.get_tokens = function (
            number,
            options,
        ) {
            ...
            type =
                number < this.NUMBER_MAX && number >= this.NUMBER_MIN
                    ? this.get_type()
                    : "decimal";
        ...
        AbbreviatedNumberFormatter.prototype.transform_number = function (
            number,
        ) {
            var sig_figs;
            if (number < this.NUMBER_MAX && number >= this.NUMBER_MIN) {
                ...
                return parseInt(
                    number.toString().slice(0, +sig_figs + 1 || 9e9),
                );
            } else {
                return number;
            }
    ...
    TwitterCldr.ShortDecimalFormatter = (function (_super) {
        ...
        function ShortDecimalFormatter() {
            return ShortDecimalFormatter.__super__.constructor.apply(
                this,
                arguments,
            );
        }
    ...
    TwitterCldr.LongDecimalFormatter = (function (_super) {
        ...
        function LongDecimalFormatter() {
            return LongDecimalFormatter.__super__.constructor.apply(
                this,
                arguments,
            );
        }
    ...
    TwitterCldr.NumberFormatter.BaseHelper = (function () {
        ...
        BaseHelper.prototype.interpolate = function (
            string,
            value,
            orientation,
        ) {
    ...
    TwitterCldr.NumberFormatter.IntegerHelper = (function (_super) {
        ...
        IntegerHelper.prototype.apply = function (number, options) {
            ...
            return this.format_groups(
                this.interpolate(this.format, parseInt(number)),
            );
        };
    ...
    TwitterCldr.NumberFormatter.FractionHelper = (function (_super) {
        ...
        FractionHelper.prototype.apply = function (fraction, options) {
            ...
            precision =
                options.precision != null ? options.precision : this.precision;
            if (precision > 0) {
                return (
                    this.decimal +
                    this.interpolate(this.format_for(options), fraction, "left")
                );
            } else {
                return "";
            }
        ...
        FractionHelper.prototype.format_for = function (options) {
            ...
            if (precision) {
                return (function () {
                    ...
                    for (
                        i = _i = 0;
                        0 <= precision ? _i < precision : _i > precision;
                        i = 0 <= precision ? ++_i : --_i
                    ) {
                        _results.push("0");
                    }
    ...
    TwitterCldr.ListFormatter = (function () {
        ...
        ListFormatter.prototype.compose_list = function (list) {
            ...
            result = this.compose(
                this.formats.end || this.formats.middle || "",
                [list[list.length - 2], list[list.length - 1]],
            );
            if (list.length > 2) {
                for (
                    i = _i = 3, _ref = list.length;
                    3 <= _ref ? _i <= _ref : _i >= _ref;
                    i = 3 <= _ref ? ++_i : --_i
                ) {
                    ...
                    result = this.compose(this.formats[format_key] || "", [
                        list[list.length - i],
                        result,
                    ]);
                }
    ...
    TwitterCldr.Bidi = (function () {
        ...
        function Bidi(options) {
            ...
            this.bidi_classes = {
                ...
                ON: {
                    1: [
                        33, 171, 174, 697, 884, 900, 1542, 1550, 5787, 6468,
                        8189, 8448, 8456, 8506, 12342, 12443, 12829, 13278,
                        42622, 64830, 65120, 65281, 126704, 127338,
                    ],
                    4: [38, 187, 8512, 65286, 65529, 127942],
                    5: [59, 91, 3059, 8478, 11493, 65307, 65339, 127792],
                    3: [
                        123, 166, 2038, 3898, 8451, 8522, 12289, 13004, 13175,
                        43048, 43124, 128249, 128320,
                    ],
                    0: [
                        161, 180, 215, 247, 894, 903, 1014, 1418, 1758, 1769,
                        3066, 5120, 6464, 8125, 8468, 8485, 8487, 8489, 8585,
                        12336, 12448, 12539, 13311, 42611, 42888, 65021, 65105,
                        65108, 65128, 65131, 65793, 67871, 119365, 120539,
                        120597, 120655, 120713, 120771, 128064,
                    ],
                    2: [
                        182, 8127, 8141, 8157, 8173, 8316, 8332, 8470, 12349,
                        12924, 42509, 65124, 65506,
                    ],
                    13: [706, 722, 127153],
                    8: [741, 65110],
                    16: [751, 127968],
                ...
                ET: {
                    ...
                    0: [
                        1423, 1642, 2555, 2801, 3065, 3647, 6107, 8494, 8723,
                        65119,
                    ],
                    4: [8240],
                    25: [8352],
                ...
                CS: {
                    0: [
                        44, 58, 160, 1548, 8239, 8260, 65104, 65106, 65109,
                        65292, 65306,
                    ],
                    1: [46, 65294],
                },
                ...
                L: {
                    ...
                    0: [
                        170, 181, 186, 750, 902, 908, 1417, 2363, 2482, 2510,
                        2519, 2563, 2654, 2691, 2761, 2768, 2880, 2903, 2947,
                        2972, 3024, 3031, 3133, 3199, 3294, 3406, 3415, 3517,
                        3716, 3722, 3725, 3749, 3751, 3773, 3782, 3894, 3896,
                        3967, 3973, 4145, 4152, 4295, 4301, 4696, 4800, 6070,
                        6108, 6314, 6743, 6753, 6965, 6971, 7082, 7143, 7150,
                        7379, 7393, 8025, 8027, 8029, 8126, 8206, 8305, 8319,
                        8450, 8455, 8469, 8484, 8486, 8488, 9109, 9900, 11559,
                        11565, 43047, 43597, 43697, 43712, 43714, 65792, 65794,
                        69632, 69932, 71340, 71350, 119970, 119995, 120134,
                    ],
                    22: [192, 3090, 3218, 6656, 11648],
                    30: [216, 8031, 13280, 66304, 127248],
                    448: [248],
                    6: [
                        699, 1369, 2425, 2474, 2548, 2602, 2730, 2858, 3449,
                        3520, 3648, 3737, 4688, 4792, 6100, 8118, 8134, 8182,
                        11680, 11688, 11696, 11704, 11712, 11720, 11728, 11736,
                        43808, 43816, 64256, 69703, 69819, 119997, 120086,
                        120138,
                    ],
                    1: [
                        720, 886, 2434, 2447, 2503, 2507, 2524, 2575, 2610,
                        2613, 2616, 2738, 2763, 2784, 2818, 2831, 2866, 2877,
                        2887, 2891, 2908, 2969, 2974, 2979, 3006, 3009, 3160,
                        3168, 3202, 3274, 3285, 3296, 3313, 3330, 3424, 3458,
                        3634, 3713, 3719, 3754, 3762, 4155, 4227, 5941, 6087,
                        6448, 6755, 7078, 7154, 7220, 7413, 8526, 11506, 11631,
                        12334, 43346, 43444, 43450, 43486, 43567, 43571, 43701,
                        44006, 65596, 69815, 71342, 110592, 119171, 119966,
                        119973, 127568,
                    ],
                    4: [
                        736, 2741, 2869, 3125, 3253, 3776, 3976, 6512, 6973,
                        8473, 8517, 12337, 12344, 43705, 64275, 120128,
                    ],
                    3: [
                        880, 890, 2365, 2377, 2486, 2493, 2649, 2749, 2962,
                        3137, 3389, 3732, 3757, 3804, 4186, 4682, 4698, 4746,
                        4786, 4802, 4882, 5902, 6435, 7401, 8144, 8490, 8508,
                        11499, 12540, 42896, 43015, 44009, 66336, 74864, 119977,
                        120071, 120123,
                    ],
                    2: [
                        904, 2382, 2527, 2622, 2674, 2703, 2911, 2958, 2984,
                        3014, 3018, 3073, 3086, 3214, 3270, 3342, 3398, 3402,
                        3535, 3570, 3745, 5998, 6441, 6681, 7146, 8130, 8178,
                        12293, 12445, 43011, 43584, 65498,
                    ],
                    19: [910, 2404],
                    82: [931],
                    139: [1015],
                    ...
                    54: [2307],
                    9: [
                        2392, 2662, 3114, 3174, 3242, 3302, 3792, 3902, 6112,
                        6160, 6784, 6800, 8458, 43000, 43250, 43600, 44016,
                        66720, 69734, 69872, 70079, 70096, 71360,
                    ],
                    7: [
                        2437, 2821, 3077, 3205, 3261, 3333, 3544, 4030, 6078,
                        7360, 8016, 43056, 43588, 43758, 120077, 120772,
                    ],
                    21: [2451, 2579, 2707, 2835],
                    11: [2534, 2990, 12992, 43214, 65536, 119982],
                    5: [
                        2565, 2949, 4039, 4231, 6451, 6765, 7406, 7960, 8008,
                        8150, 42738, 42889, 43777, 43785, 43793, 65474, 65482,
                        65490,
                    ],
                ...
                NSM: {
                    111: [768],
                    6: [
                        1155, 1750, 2385, 3636, 6071, 6744, 7394, 65056, 119173,
                    ],
                    44: [1425],
                    0: [
                        1471, 1479, 1648, 1809, 2362, 2364, 2381, 2433, 2492,
                        2509, 2620, 2641, 2677, 2748, 2765, 2817, 2876, 2879,
                        2893, 2902, 2946, 3008, 3021, 3260, 3405, 3530, 3542,
                        3633, 3761, 3893, 3895, 3897, 4038, 4226, 4237, 4253,
                        6086, 6109, 6313, 6450, 6742, 6752, 6754, 6783, 6964,
                        6972, 6978, 7083, 7142, 7149, 7405, 7412, 11647, 42655,
                        43010, 43014, 43019, 43204, 43443, 43452, 43587, 43596,
                        43696, 43713, 43766, 44005, 44008, 44013, 64286, 66045,
                        68159, 69633, 71339, 71341, 71351,
                    ],
                    1: [
                        1473, 1476, 1767, 2402, 2530, 2561, 2625, 2631, 2672,
                        2689, 2759, 2786, 2914, 3157, 3170, 3276, 3298, 3426,
                        3771, 3864, 3974, 4153, 4157, 4184, 4229, 5970, 6002,
                        6068, 6439, 6679, 7040, 7080, 7144, 7222, 12441, 42736,
                        43045, 43569, 43573, 43703, 43710, 43756, 68101, 69760,
                        69817, 70016,
                    ],
                    ...
                    3: [
                        1770, 2070, 2497, 2881, 3146, 3393, 4141, 4209, 6912,
                        7074, 7676, 12330, 42607, 43446, 68108, 69811, 94095,
                        119210,
                    ],
                    26: [1840, 2276],
                    8: [2027, 2075, 7019, 70070],
                    2: [
                        2085, 2137, 2304, 2635, 3134, 3142, 3538, 4190, 4957,
                        5906, 5938, 6155, 6432, 6457, 7151, 7376, 11503, 43392,
                        43698, 68097, 68152, 69888, 119143, 119362,
                    ],
                ...
                R: {
                    0: [
                        1470, 1472, 1475, 1478, 2042, 2074, 2084, 2088, 2142,
                        8207, 64285, 64318, 67592, 67644, 67903, 68096,
                    ],
                    26: [1488, 68121, 68440],
                    4: [1520, 64312],
                    42: [1984],
                ...
                AL: {
                    0: [
                        1544, 1547, 1549, 1563, 1969, 2208, 126500, 126503,
                        126521, 126523, 126530, 126535, 126537, 126539, 126548,
                        126551, 126553, 126555, 126557, 126559, 126564, 126590,
                    ],
                    44: [1566],
        ...
        Bidi.prototype.reorder_visually = function () {
            ...
            for (
                ...
                while (start < this.levels.length) {
                    while (
                        start < this.levels.length &&
                        this.levels[start] < depth
                    ) {
                        start += 1;
                    }
                    ...
                    finish = start + 1;
                    while (
                        finish < this.levels.length &&
                        this.levels[finish] >= depth
                    ) {
                        finish += 1;
                    }
                    for (
                        ...
                        this.string_arr[finish - i - 1] =
                            this.string_arr[start + i];
        ...
        Bidi.prototype.compute_explicit_levels = function () {
            ...
            for (
                i = _j = 0;
                0 <= size ? _j <= size : _j >= size;
                i = 0 <= size ? ++_j : --_j
            ) {
                next_fmt = i === size ? this.length : this.formatter_indices[i];
                len = next_fmt - input;
                TwitterCldr.Utilities.arraycopy(
                    this.levels,
                    input,
                    this.levels,
                    output,
        ...
        Bidi.prototype.resolve_weak_types = function () {
            ...
            for (
                run_idx = _i = 0;
                0 <= run_count ? _i < run_count : _i > run_count;
                run_idx = 0 <= run_count ? ++_i : --_i
            ) {
                start = this.get_run_start(run_idx);
                finish = this.get_run_limit(run_idx);
                level = this.get_run_level(run_idx) || 0;
                sor = TwitterCldr.Utilities.is_even(
                    TwitterCldr.Utilities.max([previous_level, level]),
                )
                    ? "L"
                    : "R";
                next_level =
                ...
                eor = TwitterCldr.Utilities.is_even(
                    TwitterCldr.Utilities.max([level, next_level]),
                )
                    ? "L"
                    : "R";
                prev_type = sor;
                ...
                for (
                    i = _j = start;
                    start <= finish ? _j < finish : _j > finish;
                    i = start <= finish ? ++_j : --_j
                ) {
        ...
        Bidi.prototype.resolve_neutral_types = function () {
            ...
            for (
                ...
                embedding_direction = TwitterCldr.Utilities.is_even(level)
                    ? "L"
                    : "R";
                sor = TwitterCldr.Utilities.is_even(
                    TwitterCldr.Utilities.max([previous_level, level]),
                ...
                for (
                    ...
                    if (new_strong !== -1) {
                        if (neutral_start !== -1) {
                            ...
                            for (
                                j = _k = neutral_start;
                                neutral_start <= i ? _k < i : _k > i;
                                j = neutral_start <= i ? ++_k : --_k
                            ) {
        ...
        Bidi.prototype.reinsert_formatting_codes = function () {
            var index,
                ...
                _ref;
            if (
                this.formatter_indices != null &&
                this.formatter_indices.length > 0
            ) {
                input = this.length;
                output = this.levels.length;
                for (
                    index = _i = _ref = this.formatter_indices.length - 1;
                    _ref <= 0 ? _i <= 0 : _i >= 0;
                    index = _ref <= 0 ? ++_i : --_i
                ) {
    ...
    TwitterCldr.Calendar = (function () {
        ...
        Calendar.calendar = {
            ...
            eras: {
                abbr: { 0: "BC", 1: "AD" },
                name: { 0: "Before Christ", 1: "Anno Domini" },
                narrow: { 0: "B", 1: "A" },
            },
            fields: {
                day: "Day",
            ...
            formats: {
                date: {
                    default: { pattern: "MMM d, y" },
                    full: { pattern: "EEEE, MMMM d, y" },
                    long: { pattern: "MMMM d, y" },
                    medium: { pattern: "MMM d, y" },
                    short: { pattern: "M/d/yy" },
                },
                datetime: {
                    default: { pattern: "{{date}}, {{time}}" },
                    full: { pattern: "{{date}} 'at' {{time}}" },
                    long: { pattern: "{{date}} 'at' {{time}}" },
                    medium: { pattern: "{{date}}, {{time}}" },
                    short: { pattern: "{{date}}, {{time}}" },
                },
                time: {
                    default: { pattern: "h:mm:ss a" },
                    full: { pattern: "h:mm:ss a zzzz" },
                    long: { pattern: "h:mm:ss a z" },
                    medium: { pattern: "h:mm:ss a" },
                    short: { pattern: "h:mm a" },
                },
            },
            months: {
                format: {
    ...
    root =
        typeof exports !== "undefined" && exports !== null
            ? exports
            : ((this.TwitterCldr = {}), this.TwitterCldr);
