...
(function() {
    ...
    TwitterCldr.TimespanFormatter = (function() {
        ...
        TimespanFormatter.prototype.format = function(seconds, fmt_options) {
            ...
            strings = function() {
                ...
                _ref = this.tokens[options["direction"]][options["unit"]][
                    options["type"]
                ][options["rule"]];
                _results = [];
    ...
    TwitterCldr.AbbreviatedNumberFormatter = (function(_super) {
        ...
        AbbreviatedNumberFormatter.prototype.default_format_options_for = function(
            number
        ) {
            return {
                precision: this.precision_from(number)
    ...
    TwitterCldr.ListFormatter = (function() {
        ...
        ListFormatter.prototype.format = function(list) {
            if (this.formats[list.length.toString()] != null) {
                return this.compose(
                    this.formats[list.length.toString()],
                    list
                );
            } else {
        ...
        ListFormatter.prototype.compose_list = function(list) {
            ...
            if (list.length > 2) {
                for (
                    ...
                    result = this.compose(
                        this.formats[format_key] || "",
                        [list[list.length - i], result]
                    );
                }
            }
            return result;
            ...
            for (
                ...
                while (start < this.levels.length) {
                    ...
                    for (
                        ...
                        this.string_arr[finish - i - 1] = this.string_arr[
                            start + i
                        ];
