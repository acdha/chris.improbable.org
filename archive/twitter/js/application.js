...
(function (exports) {
    ...
    exports.init = function () {
        ...
        twt.timeAgo = function (d, relative) {
            ...
            var diff_seconds =
                Math.abs(rightNow.getTime() - then.getTime()) / 1000;
        ...
        exports.base = {
            ...
            buildNavigation: function () {
                ...
                for (var i = 0, l = this.status_index.length; i < l; i++) {
                    ...
                    var month_index = {
                        ...
                        this_count: count,
                        this_height:
                            (status_file.tweet_count /
                                month_count_max.tweet_count) *
                            100,
                        str_title: title_str,
                        str_count: count_str,
                        data_idx: i,
            ...
            displayTweets: function (tweet_index_id) {
                ...
                if (tweet_month.year === undefined) {
                    ...
                    $(".months .with-tweets, .histogram").removeClass("active");
                    $('.months .with-tweets[data-idx="' + tweet_index_id + '"]')
                        .addClass("active")
                        .parents(".histogram")
                        .addClass("active");
                }
    ...
    exports.insertCommas = function InsertCommmas(num) {
        num = num.toString();
        return num.length > 3
            ? self.Grailbird.insertCommas(num.substr(0, num.length - 3)) +
                  "," +
                  num.substr(num.length - 3)
            : num;
    };
})(Grailbird);
